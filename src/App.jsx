            ...
            <div>
              ...
              {hasloan&&(
                <DeprecSection title="C — Loan Costs (amortize over loan term)" color="#5a3a6a" tc="#c090d8">
                  ...
                  <Row label="Appraisal on HUD-1 statement (NOT POC)" field="appraisalLender" hint="Only if appraisal appears on the HUD-1 statement itself — NOT paid outside closing. If you paid it before closing (POC), enter it in the POC section above only."/>
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:0}}>
                      <div style={{borderRight:"1px solid "+T.border,paddingRight:8}}>
                        ...
                        {[
                          ...
                          {l:"Loan costs (C)",v:grossLoanCosts,show:grossLoanCosts>0},
