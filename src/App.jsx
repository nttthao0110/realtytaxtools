    ...
    <div>
      ...
      {step===0&&(<div>
        ...
        <SB color="#1a4a3a" tc="#70d0a0" title="D — HUD-1 Expenses Currently Deductible (deduct in year of closing)">
          <div style={{display:"grid",gridTemplateColumns:"1fr",gap:0}}>
            <MF label={"Property Taxes Paid by Buyer at Closing"} hint="Taxes YOU pay at closing — deductible on Schedule E. Only enter if you are PAYING taxes (buyer's share). If seller is giving you a CREDIT for their unpaid taxes, enter that amount in Section F (Tax Proration Credit) instead — NOT here." value={inp.propertyTaxClosing} onChange={v=>s("propertyTaxClosing",v)}/>
        ...
        {/* F — Reductions */}
        <div style={{padding:"10px 14px",background:"rgba(192,112,80,0.08)",border:"1px solid rgba(192,112,80,0.3)",borderRadius:6,marginBottom:8}}>
          <p style={{fontSize:11,color:"#c07050",fontWeight:700,margin:"0 0 6px"}}>{"⚠ Property Tax — Enter in ONE place only:"}</p>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            <div style={{padding:"6px 10px",background:"rgba(74,144,96,0.1)",borderRadius:4}}>
              <p style={{fontSize:10,color:T.green,fontWeight:600,margin:"0 0 2px"}}>{"Section D (above) — you PAY taxes"}</p>
              <p style={{fontSize:9,color:T.textDim,margin:0}}>{"Deductible expense. Buyer's share of current year taxes paid at closing."}</p>
            </div>
            <div style={{padding:"6px 10px",background:"rgba(200,169,110,0.1)",borderRadius:4}}>
              <p style={{fontSize:10,color:T.amber,fontWeight:600,margin:"0 0 2px"}}>{"Section F (below) — seller CREDITS you"}</p>
              <p style={{fontSize:9,color:T.textDim,margin:0}}>{"Reduces your basis. Seller's unpaid taxes credited to buyer."}</p>
            </div>
          </div>
          <p style={{fontSize:9,color:T.textDim,margin:"6px 0 0",fontStyle:"italic"}}>{"If you have both (you pay AND receive a credit), enter each in its correct section. Most closings have only ONE."}</p>
        </div>
        <SB color="#5a2a1a" tc="#e09060" title="F — Reductions to Amount Due (all enter as POSITIVE)">
          <div style={{display:"grid",gridTemplateColumns:"1fr",gap:0}}>
            ...
            <MF label={"Tax Proration — Credit FROM Seller (reduces basis)"} hint="Use ONLY if seller is giving you a credit for their unpaid taxes. This is a REDUCTION to your cost — it lowers your basis. Do NOT also enter this in Section D above. If you are unsure, look at your HUD-1: is this listed as a CREDIT to you, or a CHARGE?" credit value={inp.taxAdjSeller} onChange={v=>s("taxAdjSeller",v)}/>
