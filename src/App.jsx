  ...
  return(
    <div style={{maxWidth:800,margin:"40px auto 0",padding:"0 20px 40px"}}>
      ...
      <p style={{fontSize:11,color:T.textDim,textAlign:"center",marginTop:24}}>
        {"For informational purposes only. Not tax advice. Consult a licensed CPA before claiming deductions."}
      </p>
    </div>
  );
}
...
function CostSegSEOBlock(){
  return(
    <div style={{maxWidth:800,margin:"40px auto 0",padding:"0 20px 40px"}}>
      ...
      <p style={{fontSize:11,color:T.textDim,textAlign:"center",marginTop:24}}>
        {"For informational purposes only. Not tax advice. Consult a licensed CPA before claiming cost segregation deductions."}
      </p>
    </div>
  );
}
...
function Exchange1031SEOBlock(){
  return(
    <div style={{maxWidth:800,margin:"40px auto 0",padding:"0 20px 40px"}}>
      ...
      <p style={{fontSize:11,color:T.textDim,textAlign:"center",marginTop:24}}>
        {"For informational purposes only. Not tax advice. 1031 exchanges are complex — always work with an experienced CPA and Qualified Intermediary."}
      </p>
    </div>
  );
}
