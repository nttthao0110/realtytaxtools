...
export default function App(){
  ...
  useEffect(()=>{
    ...
    // Only show a specific calculator title when the user is actually on the
    // calculators page. On the homepage (and other pages) show the broad brand
    // title so Google represents the whole site, not just the default tool.
