    ...
    <div style={{maxWidth:800,margin:"40px auto 0",padding:"0 20px 40px"}}>
      ...
      {[
        ...
        {q:"Does cost segregation increase my depreciation?",
         a:"Yes. Cost segregation reclassifies components of your property into shorter depreciation categories — 5-year (appliances, carpet), 7-year (fixtures), and 15-year (landscaping, driveways) — instead of the standard 27.5-year schedule. Combined with bonus depreciation (40% in 2025), cost segregation can generate significant Year 1 deductions on properties valued at $300K or more."},
      ].map((f,i)=>(
        <div key={i} style={{marginBottom:20,padding:"16px",background:T.bgCard,borderRadius:8,border:"1px solid "+T.border}}>
          <p style={{fontSize:14,fontWeight:600,color:T.gold,margin:"0 0 8px"}}>{f.q}</p>
          <p style={{fontSize:13,color:T.textMid,lineHeight:1.7,margin:0}}>{f.a}</p>
...
function STRSEOBlock(){
  return(
    <div style={{maxWidth:800,margin:"40px auto 0",padding:"0 20px 40px"}}>
      ...
      {[
        "One of the biggest tax advantages of short-term rentals is that losses may offset W-2 income if the average guest stay is 7 days or less and the owner materially participates in the activity. This creates a planning opportunity that is generally unavailable for traditional long-term rental properties — where losses are passive and can only offset other passive income. For high-income investors, this distinction alone can make a short-term rental strategy far more valuable than a comparable long-term rental.",
      ...
      {[
        {q:"Can Airbnb losses offset W-2 income?",
         a:"Yes — but only if two conditions are met. First, the average guest stay must be 7 days or less (making the activity non-passive under IRS rules). Second, you must materially participate in the rental activity, meaning you spend more than 500 hours per year managing it, or meet one of the other IRS material participation tests. When both conditions are satisfied, STR losses are treated as non-passive and can offset W-2 wages, business income, and other ordinary income with no dollar limit. This is one of the most powerful tax advantages available to active STR investors."},
        ...
        {q:"Can I deduct a loss from my STR against my W-2 income?",
         a:"Only if you meet the material participation rules. Under IRC Section 469, rental activities are generally passive, meaning losses can only offset other passive income. However, the IRS has a special rule for STRs: if the average rental period is 7 days or less, and you materially participate (spending more than 500 hours or meeting other IRS tests), the activity may be treated as non-passive — allowing losses to offset W-2 and other ordinary income. This is a significant tax planning opportunity that requires documentation of your participation hours."},
...
function CostSegSEOBlock(){
  return(
    <div style={{maxWidth:800,margin:"40px auto 0",padding:"0 20px 40px"}}>
      ...
      <p style={{fontSize:14,color:T.textMid,lineHeight:1.7,marginBottom:14}}>
        {"Bonus depreciation allows investors to immediately deduct a percentage of qualifying 5-year, 7-year, and 15-year property placed in service during the year. Under current law, the bonus depreciation rate for qualifying property placed in service during 2025 is 40%. Future percentages may change if tax legislation is modified. Because cost segregation identifies assets eligible for bonus depreciation, many investors use both strategies together to maximize first-year deductions."}
      </p>
      ...
      {[
        ...
        {q:"What is bonus depreciation and how does it work in 2025?",
         a:"Bonus depreciation allows you to immediately deduct a percentage of qualifying assets in the year placed in service. In 2025, the rate is 40% for 5-year, 7-year, and 15-year property. The building structure (27.5-year) does not qualify. Under current law, bonus depreciation is scheduled to continue phasing down, although future legislation could change these percentages."},
      ...
      <div style={{background:T.bgCard2,border:"1px solid "+T.border,borderRadius:8,padding:"20px 24px",marginBottom:16}}>
        ...
        {[
          {label:"Bonus depreciation (40% × $80,000 reclassified assets)",value:"$32,000",note:false},
          {label:"Remaining reclassified assets depreciated over 5–15 years",value:"Additional deductions",note:true},
          {label:"Remaining building basis continues on 27.5-year schedule",value:"Continues normally",note:true},
        ].map((row,i)=>(
          <div key={i} style={{display:"flex",justifyContent:"space-between",padding:"6px 0",borderBottom:"1px solid "+T.border+"50"}}>
            <span style={{fontSize:12,color:T.textMid}}>{row.label}</span>
            <span style={{fontSize:12,color:row.note?T.textDim:T.text,fontFamily:"monospace",fontStyle:row.note?"italic":"normal"}}>{row.value}</span>
          </div>
        ))}
        <div style={{marginTop:14,padding:"12px 16px",background:"rgba(200,169,110,0.08)",borderRadius:6,border:"1px solid "+T.goldDim+"40"}}>
          <p style={{fontSize:13,color:T.gold,fontWeight:600,margin:"0 0 6px"}}>{"Estimated Year 1 deduction: $45,000–$55,000"}</p>
          <p style={{fontSize:12,color:T.textMid,margin:"0 0 4px"}}>{"(depending on study results and placed-in-service date)"}</p>
          <p style={{fontSize:12,color:T.textMid,margin:0}}>{"At a 32% tax bracket → potential Year 1 tax savings: $10,000–$15,000+"}</p>
        </div>
        <p style={{fontSize:11,color:T.textDim,marginTop:12,marginBottom:0,fontStyle:"italic"}}>
          {"Many investors recover the full cost of the study ($5,000–$10,000) in Year 1 tax savings alone."}
        </p>
      </div>
...
const SCHEMA = {
  depreciation: {
    page: {
      ...
      "author":{"@type":"Person","name":"RealtyTaxTools CPA Team"}
    },
    faq: {
      "@context":"https://schema.org",
      "@type":"FAQPage",
  ...
  costseg: {
    ...
    faq: {
      ...
      "mainEntity":[
        ...
        {"@type":"Question","name":"What is bonus depreciation and how does it work in 2025?","acceptedAnswer":{"@type":"Answer","text":"Bonus depreciation (Section 168(k)) allows qualifying 5-, 7-, and 15-year property to be deducted at an accelerated rate in Year 1. The rate is 40% in 2025, down from 60% in 2024 and 80% in 2023. Without bonus depreciation, cost segregation assets are still depreciated faster than 27.5 years."}},
        {"@type":"Question","name":"Does cost segregation trigger depreciation recapture when I sell?","acceptedAnswer":{"@type":"Answer","text":"Yes. Personal property (5/7-year) is subject to Section 1245 recapture at ordinary income rates. Building components are subject to Section 1250 recapture at a maximum 25%. A 1031 exchange defers both types of recapture by rolling the basis into a replacement property."}},
  ...
  capitalgains: {
    ...
    faq: {
      ...
      "mainEntity":[
        ...
        {"@type":"Question","name":"What are the 2025 long-term capital gains rates?","acceptedAnswer":{"@type":"Answer","text":"For 2025, long-term capital gains rates are: 0% for taxable income up to $48,350 (single) / $96,700 (married filing jointly); 15% for income up to $533,400 (single) / $600,050 (MFJ); and 20% above those thresholds. An additional 3.8% Net Investment Income Tax applies if your MAGI exceeds $200,000 (single) / $250,000 (MFJ)."}},
...
export default function App(){
  ...
  useEffect(()=>{
    ...
    if(titles[activeCalc]) document.title=titles[activeCalc];
  },[activeCalc]);
  const L=LANG[lang];
